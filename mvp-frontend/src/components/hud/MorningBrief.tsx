...
export function MorningBrief() {
  ...
  return (
    <div className="absolute left-1/2 top-20 z-30 w-[360px] -translate-x-1/2 rounded-xl border border-amber-500/30 bg-gray-900/95 p-4 shadow-2xl backdrop-blur-sm">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-bold text-amber-400">🌅 晨间简报</h3>
        <button onClick={() => setDismissed(true)} className="text-xs text-gray-400 hover:text-white">✕ 关闭</button>
      </div>
